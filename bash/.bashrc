...
if [ "$color_prompt" = yes ]; then
    PS1='\[\033[01;34m\]\w\[\033[01;32m\]\nBol-bhai\[\033[01;33m\]$(parse_git_branch | sed "s/^/(Git-/;s/$/)/")\[\033[00m\]\$ '
else
    PS1='\[\033[01;34m\]\w\[\033[01;32m\]\nBol-bhai\[\033[01;33m\]$(parse_git_branch | sed "s/^/(Git-/;s/$/)/")\[\033[00m\]\$ '
fi
...
alias back='cd ~/Desktop/DVM ; ls -A'
alias ..='cd ..'
alias ...='cd ../..'
...
alias v='vim'
alias home='cd ~'
alias tor='/home/avyakt/Downloads/tor-browser/./avi_start_tor.sh'
alias my='ssh root@64.227.138.56'
alias obs='flatpak run com.obsproject.Studio'
alias avi='ssh root@64.227.138.56'
